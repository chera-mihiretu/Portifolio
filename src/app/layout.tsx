...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Competitive Programming Ethiopia',
    'EtCP Ethiopia',
    'EtCP Ethiopia Finalist',
    'EtCP Ethiopia Winner',
    'EtCP Ethiopia Runner-up',
    'EtCP Ethiopia Top 3',
    'EtCP Ethiopia Top 5',
    'EtCP Ethiopia Top 10',
    'EtCP Ethiopia Top 20',
    'EtCP Ethiopia Top 50',
    'Chara',
    "Carraa Miratu",
    'Cara',
    'Miratu',
    ...
    'carraa miratu',
    'carraa miratu chera',
    'carraa miratu chera mihiretu',
    'carraa miratu chera mihiretu chare',
    'carraa miratu chera mihiretu chare chare',
    'carraa miratu chera mihiretu chare chare chare',
    'carraa miratu chera mihiretu chare chare chare chare',
    'carraa miratu chera mihiretu chare chare chare chare chare',
